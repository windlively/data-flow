        ...
        <div style="width: 100%; height: 100%; padding: 10px">
            ...
            <nz-row nzGutter="20">
                <nz-col style="margin-bottom: 20px" nzXXl="6" nzXl="8" nzMd="12" nzSm="24"
                        *ngFor="let instance of instanceList">
                    <div class="instance-info-card" matRipple
                        ...
                        <i nz-icon *ngIf="!!instance['active']">
                            <svg t="1612097473212" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                ...
                                <path d="M512 42.666667a469.333333 469.333333 0 1 0 0 938.666666 469.333333 469.333333 0 0 0 0-938.666666z"
                                      fill="#47C55B"
                                      p-id="20010"></path>
                            </svg>
                        </i>
                        ...
                        &nbsp;
                        <span style="font-weight: bolder; font-size: 16px">{{ instance.name }}</span>&nbsp;&nbsp;<span>({{ instance['active'] ? '活动中' : '离线' }}
                        )</span>
                    </div>
                </nz-col>
            </nz-row>
