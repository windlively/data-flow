    ...
    template: `
      ...
      <div style="width: 100%; height: 100%; padding: 10px">
        ...
        <nz-row nzGutter="20">
          ...
          @for (instance of instanceList; track instance) {
            <nz-col style="margin-bottom: 20px" nzXXl="6" nzXl="8" nzMd="12" nzSm="24">
              <div class="instance-info-card" matRipple
                   (click)="showInstanceChart(instance.name, instance['active'])">
                @if (!!instance['active']) {
                  <i nz-icon>
                    <svg t="1612097473212" class="icon" viewBox="0 0 1024 1024" version="1.1"
                         xmlns="http://www.w3.org/2000/svg" p-id="20009">
                      <path
                        d="M512 42.666667a469.333333 469.333333 0 1 0 0 938.666666 469.333333 469.333333 0 0 0 0-938.666666z"
                        fill="#47C55B"
                        p-id="20010"></path>
                    </svg>
                  </i>
                ...
                &nbsp;
                <span
                  style="font-weight: bolder; font-size: 16px">{{ instance.name }}</span>&nbsp;&nbsp;<span>({{ instance['active'] ? '活动中' : '离线' }}
                )</span>
              </div>
            </nz-col>
          }
...
export class InstanceStatusComponent implements OnInit {
  ...
  showInstanceChart = (instanceName: string, active: boolean) => {
    ...
    const ref = this.chartContainer.createComponent(StatisticsTemplateComponent);
